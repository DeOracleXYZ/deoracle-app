...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (chainId === 69) {
      ...
      setDeOracleREAD(new ethers.Contract(optimismAddress, deOracleABI, provider));
      setDeOracleWRITE(new ethers.Contract(optimismAddress, deOracleABI, provider.getSigner()));
    } //if Mumbai
    if (chainId === 80001) {
      setDeOracleAddress(mumbaiAddress);
